package com.ldlywt.library.download;

import android.widget.Toast;

import com.ldlywt.library.RxNet;
import com.ldlywt.library.exception.ApiException;
...
public abstract class BaseDownloadObserver implements Observer<ResponseBody> {
    ...
    protected void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(RxNet.getInstance().getContext(), msg, Toast.LENGTH_SHORT);
        } else {
            mToast.setText(msg);
        }
        mToast.show();
